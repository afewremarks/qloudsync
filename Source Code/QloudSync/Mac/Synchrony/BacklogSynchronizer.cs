...
//
//                List<StorageQloudObject> filesInLocalRepo = LocalRepo.GetSQObjects ();
//                List<StorageQloudObject> filesInRemoteRepo = remoteRepo.Files;
//                filesInRemoteRepo.AddRange(remoteRepo.AllFoldersOutsideTrash);
...
//            }
        ...
        protected void UpdateFile(StorageQloudObject file, XmlNode node_file)
        {
...
//            Save ();
        ...
        protected StorageQloudObject Get (string absolutePath)
        {
