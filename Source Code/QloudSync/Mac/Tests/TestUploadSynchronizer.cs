...
//            StorageQloudObject f = new StorageQloudObject(filepath);
...
//            StorageQloudObject nf = new StorageQloudObject(newpath);
//            DateTime init = DateTime.Now;
//            while (DateTime.Now.Subtract(init).TotalSeconds<20);
//
...
//            StorageQloudObject nf = new StorageQloudObject(filepath);
//            DateTime init = DateTime.Now;
//            while (DateTime.Now.Subtract(init).TotalSeconds<20);
