        ...
        */
        ...
        public void Write ()
        {
            ...
            try {
                ...
                if (System.IO.File.Exists(SQ.Util.Constant.BACKLOG_FILE))
                    System.IO.File.Delete (SQ.Util.Constant.BACKLOG_FILE);
                
                
                int i = 1;
                
                using (System.IO.FileStream fs = System.IO.File.Create(SQ.Util.Constant.BACKLOG_FILE))
                {
                    
                    foreach (SQ.Repository.File f in LocalRepo.Files) {
                ...
                SQ.Util.Logger.LogInfo ("Debug", "Collection was modified; Write");
                //Write ();
            } catch (System.IO.IOException e) {
                SQ.Util.Logger.LogInfo ("Debug", e);
                //Write ();
            }
