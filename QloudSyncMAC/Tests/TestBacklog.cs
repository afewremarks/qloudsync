...
//
//        [Test ()]
//        public void TestSynchronizeDeleteStorageQloudObjectOffline(){
//
...
//            StorageQloudObject file = new StorageQloudObject(path);
//
...
//
//        [Test ()]
//        public void TestSynchronizeCreateStorageQloudObjectOffline(){
//            util.ClearRepositories();
//
//            
//            string path = Path.Combine(RuntimeSettings.HomePath, "Testfile.txt");
...
//            StorageQloudObject newfile = new StorageQloudObject(path);
//            //sincronizar
//            BacklogSynchronizer.GetInstance().Synchronize();
...
//
//        [Test ()]
//        public void TestSynchronizeChangeStorageQloudObjectOffline(){
//
////            util.ClearRepositories();
////
////            string path = Path.Combine(RuntimeSettings.HomePath, "Testfile.txt");
...
////            StorageQloudObject file2 = new StorageQloudObject(path);
////            //sincronizar
////            BacklogSynchronizer.GetInstance().Synchronize();
