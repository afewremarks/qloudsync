    ...
    public class RuntimeSettings : Settings
    {
        ...
        public static string TrashPath { 
            get {
                if (Environment.OSVersion.Platform == PlatformID.Win32NT)
                    ...
                    return Path.Combine(Environment.GetFolderPath (Environment.SpecialFolder.Personal), string.Format(".trash{0}",Path.DirectorySeparatorChar));
            }
        }
        ...
        public static string HomePath{
            get {
                ...
                {
                    if (Environment.OSVersion.Platform == PlatformID.Win32NT)
                        homePath = Path.Combine(Environment.GetFolderPath (Environment.SpecialFolder.UserProfile), GlobalSettings.HomeFolderName+System.IO.Path.DirectorySeparatorChar);
                    else
