...
namespace GreenQloud.Persistence.SQLite{
    ...
    public class SQLiteDatabase
    {
        ...
        public void CreateDataBase(){
            ...
            ExecuteNonQuery ("CREATE TABLE RepositoryItem (RepositoryItemID INTEGER PRIMARY KEY AUTOINCREMENT , Name ntext, RelativePath ntext, RepoPath ntext, IsFolder ntext, Deleted ntext, ResultObject ntext, eTag ntext)");
